/**
 * Texte de la fiche « À propos ».
 *
 * PREMIER JET, ecrit a partir des chiffres reels de la collection — les annees
 * 90 et 2000 qui dominent, l'Alternative Rock sur un album sur quatre, Black
 * Sabbath deux fois dans les dix premiers, Daft Punk en tete d'une liste tenue
 * par les guitares. A reecrire a la premiere personne, c'est un manifesto.
 *
 * Tout se modifie ici : `about-dialog.tsx` ne fait que rendre ce tableau, un
